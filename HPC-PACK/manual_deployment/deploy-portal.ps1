...
Write-Host "New-AzResourceGroup -Name 'jacomini-hpcpack-hseries-ib-eastus' -Location 'East US'"
Write-Host "NO AD"
...
Write-Host "New-AzResourceGroupDeployment -TemplateFile 'new-1hn-wincn-ad.bicep' -TemplateParameterFile 'azuredeployNoAD.parameters.json' -Verbose"
Write-Host ""
...
Write-Host "New-AzResourceGroupDeployment -TemplateFile 'new-1hn-wincn-exisiting-ad.bicep' -TemplateParameterFile 'azuredeploy.parametersAD.json' -Verbose"
